require.config({
    ...
    paths: {
        ...
        "mceliece": "lib/post_quantum/mceliece2",
        "sidh": "lib/post_quantum/sidh",
        "rlwe": "lib/post_quantum/rlwe",
        "merkle": "lib/post_quantum/merkle",
        "lamport": "lib/post_quantum/lamport"
    },
    shim: {
        "bootstrap": {
            deps: ['jquery']
...
define(['jquery', 'client', 'events', 'merkle'], function($, client, $_) {
    "use strict";
    ...
    $('#sendMessage').on('click', function () {
        ...
        switch (client.context["status"]) {
            ...
            default:
                alert("something is wrong, contact the developers");
        }
